...
<head>
    ...
    <link rel="shortcut icon"
          href="{{asset(get_setting('site_favicon')->value)}}" type="image/x-icon">
                    ...
                    <table>
                        ...
                        @foreach($order->order_details as $order_detail)
                            <tr>
                                ...
                                <td class="tm_width_5 tm_accent_border_20">{{$order_detail->product->name_en ?? ' '}}<br>
                                    <small>
...
{{--                            <td colspan="3" class="tm_border_none "><p class="tm_m0">Payment Status: Unpaid</p></td>--}}
                        ...
                        <tr class="tm_border_none" style="border:none !important;">
                            <td colspan="3" class="tm_border_none" style="border:none !important;"></td>
    ...
    <table width="600px">
        ...
        <tr style="padding-top: 100px">
            <td colspan="4" style="margin-right: 80px !important;">
                <p class="tm_m0 tm_f18 tm_accent_color tm_mb5" style="margin-right: 200px !important;">Thank you for your business.</p>
            ...
            <td align="right" style="padding-left: 100px">
                ...
                @endphp
                @if($logo != null)
                        <img src="data:image/png;base64,{{base64_encode(file_get_contents(base_path('public/'.get_setting('site_favicon')->value)))}} "  alt="{{ env('APP_NAME') }}" width="120px">

                @else
                    <img src="{{ asset('upload/no_image.jpg') }}" alt="{{ env('APP_NAME') }}" width="50px">
                @endif
{{--                <img src="data:image/png;base64,{{base64_encode(file_get_contents(base_path('public/backend/assets/imgs/sky-dream-it-skydreamit-tanmoy-biswas-ceo-webdesigner-wordpress-expert.png')))}} " width="50px">--}}
            </td>
        </tr>
    </table>
</footer>
