                        ...
                        <div class="col-md-12">
                           <form class="form-horizontal" action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
			                    ...
			                    <div class="form-group row mb-4">
			                        <label class="col-md-3 col-form-label" for="name_en">Name <span class="text-danger">*</span></label>
			                        <div class="col-md-9">
			                            <input type="text" placeholder="Name English" id="name_en" name="name_en" value="{{old('name_en')}}" class="form-control" required>
										@error('name_en')
			                    ...
			                    <div class="mb-4">
                                    <label for="image" class="col-form-label" style="font-weight: bold;">Image <span class="text-danger">*</span></label>
